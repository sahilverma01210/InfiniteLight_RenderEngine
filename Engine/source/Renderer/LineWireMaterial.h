				...
				Step unoccluded("flat_shading");
				{
					// Add Resources
					{
						// Add Constants
						{
							...
							m_lineWireMatHandles.solidConstIdx = gfx.LoadResource(std::make_shared<ConstantBuffer>(gfx, sizeof(data), static_cast<const void*>(&data)), ResourceType::Constant);
						}
					}
				}
					...
					Step occluded("wireframe");
					{
						// Add Resources
						{
							// Add Constants
							{
								...
								m_lineWireMatHandles.wireConstIdx = gfx.LoadResource(std::make_shared<ConstantBuffer>(gfx, sizeof(data), static_cast<const void*>(&data)), ResourceType::Constant);
							}
						}
					}
