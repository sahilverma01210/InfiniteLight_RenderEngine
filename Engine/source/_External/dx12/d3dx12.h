...
//------------------------------------------------------------------------------------------------
inline bool operator==( const D3D12_VIEWPORT& l, const D3D12_VIEWPORT& r ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_RECT : public D3D12_RECT
{
    ...
    explicit CD3DX12_RECT( const D3D12_RECT& o ) noexcept(!IS_DEBUG) :
        D3D12_RECT( o )
    {}
...
struct CD3DX12_VIEWPORT : public D3D12_VIEWPORT
{
    ...
    explicit CD3DX12_VIEWPORT( const D3D12_VIEWPORT& o ) noexcept(!IS_DEBUG) :
        D3D12_VIEWPORT( o )
    {}
    explicit CD3DX12_VIEWPORT(
        ...
        FLOAT maxDepth = D3D12_MAX_DEPTH ) noexcept(!IS_DEBUG)
    {
        TopLeftX = topLeftX;
        TopLeftY = topLeftY;
        Width = width;
...
{
    CD3DX12_BOX() = default;
    explicit CD3DX12_BOX( const D3D12_BOX& o ) noexcept(!IS_DEBUG) :
        D3D12_BOX( o )
    {}
    explicit CD3DX12_BOX(
        LONG Left,
        LONG Right ) noexcept(!IS_DEBUG)
    {
...
inline bool operator==( const D3D12_BOX& l, const D3D12_BOX& r ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_DEPTH_STENCIL_DESC : public D3D12_DEPTH_STENCIL_DESC
{
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC( const D3D12_DEPTH_STENCIL_DESC& o ) noexcept(!IS_DEBUG) :
        D3D12_DEPTH_STENCIL_DESC( o )
    {}
    explicit CD3DX12_DEPTH_STENCIL_DESC( CD3DX12_DEFAULT ) noexcept(!IS_DEBUG)
    {
        DepthEnable = TRUE;
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC(
        ...
        D3D12_COMPARISON_FUNC backStencilFunc ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_DEPTH_STENCIL_DESC1 : public D3D12_DEPTH_STENCIL_DESC1
{
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC1( const D3D12_DEPTH_STENCIL_DESC1& o ) noexcept(!IS_DEBUG) :
        D3D12_DEPTH_STENCIL_DESC1( o )
    {}
    explicit CD3DX12_DEPTH_STENCIL_DESC1( const D3D12_DEPTH_STENCIL_DESC& o ) noexcept(!IS_DEBUG)
    {
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC1( CD3DX12_DEFAULT ) noexcept(!IS_DEBUG)
    {
        DepthEnable = TRUE;
        DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ALL;
        DepthFunc = D3D12_COMPARISON_FUNC_LESS;
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC1(
        ...
        BOOL depthBoundsTestEnable ) noexcept(!IS_DEBUG)
    {
        DepthEnable = depthEnable;
        DepthWriteMask = depthWriteMask;
        DepthFunc = depthFunc;
    ...
    operator D3D12_DEPTH_STENCIL_DESC() const noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_BLEND_DESC : public D3D12_BLEND_DESC
{
    ...
    explicit CD3DX12_BLEND_DESC( const D3D12_BLEND_DESC& o ) noexcept(!IS_DEBUG) :
        D3D12_BLEND_DESC( o )
    {}
    explicit CD3DX12_BLEND_DESC( CD3DX12_DEFAULT ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_RASTERIZER_DESC : public D3D12_RASTERIZER_DESC
{
    ...
    explicit CD3DX12_RASTERIZER_DESC( const D3D12_RASTERIZER_DESC& o ) noexcept(!IS_DEBUG) :
        D3D12_RASTERIZER_DESC( o )
    {}
    explicit CD3DX12_RASTERIZER_DESC( CD3DX12_DEFAULT ) noexcept(!IS_DEBUG)
    {
    ...
    explicit CD3DX12_RASTERIZER_DESC(
        ...
        D3D12_CONSERVATIVE_RASTERIZATION_MODE conservativeRaster) noexcept(!IS_DEBUG)
    {
        FillMode = fillMode;
        CullMode = cullMode;
...
struct CD3DX12_RESOURCE_ALLOCATION_INFO : public D3D12_RESOURCE_ALLOCATION_INFO
{
    ...
    explicit CD3DX12_RESOURCE_ALLOCATION_INFO( const D3D12_RESOURCE_ALLOCATION_INFO& o ) noexcept(!IS_DEBUG) :
        D3D12_RESOURCE_ALLOCATION_INFO( o )
    {}
    CD3DX12_RESOURCE_ALLOCATION_INFO(
        UINT64 size,
        UINT64 alignment ) noexcept(!IS_DEBUG)
    {
        SizeInBytes = size;
        Alignment = alignment;
    }
...
struct CD3DX12_HEAP_PROPERTIES : public D3D12_HEAP_PROPERTIES
{
    ...
    explicit CD3DX12_HEAP_PROPERTIES(const D3D12_HEAP_PROPERTIES &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_HEAP_PROPERTIES(
        ...
        UINT nodeMask = 1 ) noexcept(!IS_DEBUG)
    {
    ...
    bool IsCPUAccessible() const noexcept(!IS_DEBUG)
    {
        return Type == D3D12_HEAP_TYPE_UPLOAD || Type == D3D12_HEAP_TYPE_READBACK || (Type == D3D12_HEAP_TYPE_CUSTOM &&
            (CPUPageProperty == D3D12_CPU_PAGE_PROPERTY_WRITE_COMBINE || CPUPageProperty == D3D12_CPU_PAGE_PROPERTY_WRITE_BACK));
    }
};
inline bool operator==( const D3D12_HEAP_PROPERTIES& l, const D3D12_HEAP_PROPERTIES& r ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_HEAP_DESC : public D3D12_HEAP_DESC
{
    ...
    explicit CD3DX12_HEAP_DESC(const D3D12_HEAP_DESC &o) noexcept(!IS_DEBUG) :
        D3D12_HEAP_DESC(o)
    {}
    CD3DX12_HEAP_DESC(
        UINT64 size,
        ...
        UINT64 alignment = 0,
        D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE ) noexcept(!IS_DEBUG)
    {
        SizeInBytes = size;
...
inline bool operator==( const D3D12_HEAP_DESC& l, const D3D12_HEAP_DESC& r ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE
{
    ...
    explicit CD3DX12_CLEAR_VALUE(const D3D12_CLEAR_VALUE &o) noexcept(!IS_DEBUG) :
        D3D12_CLEAR_VALUE(o)
    {}
    CD3DX12_CLEAR_VALUE(
        DXGI_FORMAT format,
        const FLOAT color[4] ) noexcept(!IS_DEBUG)
    {
        Format = format;
    ...
    CD3DX12_CLEAR_VALUE(
        DXGI_FORMAT format,
        FLOAT depth,
        UINT8 stencil ) noexcept(!IS_DEBUG)
    {
        Format = format;
...
struct CD3DX12_RANGE : public D3D12_RANGE
{
    ...
    explicit CD3DX12_RANGE(const D3D12_RANGE &o) noexcept(!IS_DEBUG) :
        D3D12_RANGE(o)
    {}
    CD3DX12_RANGE(
        SIZE_T begin,
        SIZE_T end ) noexcept(!IS_DEBUG)
    {
        Begin = begin;
        End = end;
    }
...
struct CD3DX12_RANGE_UINT64 : public D3D12_RANGE_UINT64
{
    ...
    explicit CD3DX12_RANGE_UINT64(const D3D12_RANGE_UINT64 &o) noexcept(!IS_DEBUG) :
        D3D12_RANGE_UINT64(o)
    {}
    CD3DX12_RANGE_UINT64(
        UINT64 begin,
        UINT64 end ) noexcept(!IS_DEBUG)
    {
        Begin = begin;
        End = end;
    }
...
struct CD3DX12_SUBRESOURCE_RANGE_UINT64 : public D3D12_SUBRESOURCE_RANGE_UINT64
{
    ...
    explicit CD3DX12_SUBRESOURCE_RANGE_UINT64(const D3D12_SUBRESOURCE_RANGE_UINT64 &o) noexcept(!IS_DEBUG) :
        D3D12_SUBRESOURCE_RANGE_UINT64(o)
    {}
    CD3DX12_SUBRESOURCE_RANGE_UINT64(
        UINT subresource,
        const D3D12_RANGE_UINT64& range ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_SHADER_BYTECODE : public D3D12_SHADER_BYTECODE
{
    ...
    explicit CD3DX12_SHADER_BYTECODE(const D3D12_SHADER_BYTECODE &o) noexcept(!IS_DEBUG) :
        D3D12_SHADER_BYTECODE(o)
    {}
    CD3DX12_SHADER_BYTECODE(
        _In_ ID3DBlob* pShaderBlob ) noexcept(!IS_DEBUG)
    {
    ...
    CD3DX12_SHADER_BYTECODE(
        ...
        SIZE_T bytecodeLength ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_TILED_RESOURCE_COORDINATE : public D3D12_TILED_RESOURCE_COORDINATE
{
    ...
    explicit CD3DX12_TILED_RESOURCE_COORDINATE(const D3D12_TILED_RESOURCE_COORDINATE &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_TILED_RESOURCE_COORDINATE(
        ...
        UINT y,
        UINT z,
        UINT subresource ) noexcept(!IS_DEBUG)
    {
        X = x;
        Y = y;
        Z = z;
...
struct CD3DX12_TILE_REGION_SIZE : public D3D12_TILE_REGION_SIZE
{
    ...
    explicit CD3DX12_TILE_REGION_SIZE(const D3D12_TILE_REGION_SIZE &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_TILE_REGION_SIZE(
        ...
        UINT width,
        UINT16 height,
        UINT16 depth ) noexcept(!IS_DEBUG)
    {
        NumTiles = numTiles;
        UseBox = useBox;
        Width = width;
...
struct CD3DX12_SUBRESOURCE_TILING : public D3D12_SUBRESOURCE_TILING
{
    ...
    explicit CD3DX12_SUBRESOURCE_TILING(const D3D12_SUBRESOURCE_TILING &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_SUBRESOURCE_TILING(
        ...
        UINT16 depthInTiles,
        UINT startTileIndexInOverallResource ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_TILE_SHAPE : public D3D12_TILE_SHAPE
{
    ...
    explicit CD3DX12_TILE_SHAPE(const D3D12_TILE_SHAPE &o) noexcept(!IS_DEBUG) :
        D3D12_TILE_SHAPE(o)
    {}
    CD3DX12_TILE_SHAPE(
        UINT widthInTexels,
        UINT heightInTexels,
        UINT depthInTexels ) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_RESOURCE_BARRIER : public D3D12_RESOURCE_BARRIER
{
    ...
    explicit CD3DX12_RESOURCE_BARRIER(const D3D12_RESOURCE_BARRIER &o) noexcept(!IS_DEBUG) :
    ...
    static inline CD3DX12_RESOURCE_BARRIER Transition(
        ...
        D3D12_RESOURCE_BARRIER_FLAGS flags = D3D12_RESOURCE_BARRIER_FLAG_NONE) noexcept(!IS_DEBUG)
    {
    ...
    static inline CD3DX12_RESOURCE_BARRIER Aliasing(
        ...
        _In_ ID3D12Resource* pResourceAfter) noexcept(!IS_DEBUG)
    {
        CD3DX12_RESOURCE_BARRIER result = {};
        D3D12_RESOURCE_BARRIER &barrier = result;
    ...
    static inline CD3DX12_RESOURCE_BARRIER UAV(
        _In_ ID3D12Resource* pResource) noexcept(!IS_DEBUG)
    {
        CD3DX12_RESOURCE_BARRIER result = {};
        D3D12_RESOURCE_BARRIER &barrier = result;
...
struct CD3DX12_PACKED_MIP_INFO : public D3D12_PACKED_MIP_INFO
{
    ...
    explicit CD3DX12_PACKED_MIP_INFO(const D3D12_PACKED_MIP_INFO &o) noexcept(!IS_DEBUG) :
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
    ...
    explicit CD3DX12_SUBRESOURCE_FOOTPRINT(const D3D12_SUBRESOURCE_FOOTPRINT &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_SUBRESOURCE_FOOTPRINT(
        ...
        UINT height,
        UINT depth,
        UINT rowPitch ) noexcept(!IS_DEBUG)
    {
        Format = format;
        Width = width;
        Height = height;
...
struct CD3DX12_TEXTURE_COPY_LOCATION : public D3D12_TEXTURE_COPY_LOCATION
{
    ...
    explicit CD3DX12_TEXTURE_COPY_LOCATION(const D3D12_TEXTURE_COPY_LOCATION &o) noexcept(!IS_DEBUG) :
        D3D12_TEXTURE_COPY_LOCATION(o)
    {}
    CD3DX12_TEXTURE_COPY_LOCATION(_In_ ID3D12Resource* pRes) noexcept(!IS_DEBUG)
    {
        pResource = pRes;
        Type = D3D12_TEXTURE_COPY_TYPE_SUBRESOURCE_INDEX;
        PlacedFootprint = {};
    }
    CD3DX12_TEXTURE_COPY_LOCATION(_In_ ID3D12Resource* pRes, D3D12_PLACED_SUBRESOURCE_FOOTPRINT const& Footprint) noexcept(!IS_DEBUG)
    {
        pResource = pRes;
        Type = D3D12_TEXTURE_COPY_TYPE_PLACED_FOOTPRINT;
        PlacedFootprint = Footprint;
    }
    CD3DX12_TEXTURE_COPY_LOCATION(_In_ ID3D12Resource* pRes, UINT Sub) noexcept(!IS_DEBUG)
    {
        pResource = pRes;
        Type = D3D12_TEXTURE_COPY_TYPE_SUBRESOURCE_INDEX;
        PlacedFootprint = {};
...
struct CD3DX12_DESCRIPTOR_RANGE : public D3D12_DESCRIPTOR_RANGE
{
    ...
    explicit CD3DX12_DESCRIPTOR_RANGE(const D3D12_DESCRIPTOR_RANGE &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_DESCRIPTOR_RANGE(
        ...
        D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE : public D3D12_ROOT_DESCRIPTOR_TABLE
{
    ...
    explicit CD3DX12_ROOT_DESCRIPTOR_TABLE(const D3D12_ROOT_DESCRIPTOR_TABLE &o) noexcept(!IS_DEBUG) :
        D3D12_ROOT_DESCRIPTOR_TABLE(o)
    {}
    CD3DX12_ROOT_DESCRIPTOR_TABLE(
        UINT numDescriptorRanges,
        _In_reads_opt_(numDescriptorRanges) const D3D12_DESCRIPTOR_RANGE* _pDescriptorRanges) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_ROOT_CONSTANTS : public D3D12_ROOT_CONSTANTS
{
    ...
    explicit CD3DX12_ROOT_CONSTANTS(const D3D12_ROOT_CONSTANTS &o) noexcept(!IS_DEBUG) :
        D3D12_ROOT_CONSTANTS(o)
    {}
    CD3DX12_ROOT_CONSTANTS(
        UINT num32BitValues,
        UINT shaderRegister,
        UINT registerSpace = 0) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_ROOT_DESCRIPTOR : public D3D12_ROOT_DESCRIPTOR
{
    ...
    explicit CD3DX12_ROOT_DESCRIPTOR(const D3D12_ROOT_DESCRIPTOR &o) noexcept(!IS_DEBUG) :
    ...
    static inline void Init(_Out_ D3D12_ROOT_DESCRIPTOR &table, UINT shaderRegister, UINT registerSpace = 0) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER
{
    ...
    explicit CD3DX12_ROOT_PARAMETER(const D3D12_ROOT_PARAMETER &o) noexcept(!IS_DEBUG) :
    ...
    static inline void InitAsDescriptorTable(
        ...
        D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC
{
    ...
    explicit CD3DX12_STATIC_SAMPLER_DESC(const D3D12_STATIC_SAMPLER_DESC &o) noexcept(!IS_DEBUG) :
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC
{
    ...
    explicit CD3DX12_ROOT_SIGNATURE_DESC(const D3D12_ROOT_SIGNATURE_DESC &o) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_ROOT_SIGNATURE_DESC(
        ...
        D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_NONE) noexcept(!IS_DEBUG)
    {
        Init(numParameters, _pParameters, numStaticSamplers, _pStaticSamplers, flags);
    }
    CD3DX12_ROOT_SIGNATURE_DESC(CD3DX12_DEFAULT) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_DESCRIPTOR_RANGE1 : public D3D12_DESCRIPTOR_RANGE1
{
    ...
    explicit CD3DX12_DESCRIPTOR_RANGE1(const D3D12_DESCRIPTOR_RANGE1 &o) noexcept(!IS_DEBUG) :
...
struct CD3DX12_ROOT_DESCRIPTOR_TABLE1 : public D3D12_ROOT_DESCRIPTOR_TABLE1
{
    ...
    explicit CD3DX12_ROOT_DESCRIPTOR_TABLE1(const D3D12_ROOT_DESCRIPTOR_TABLE1 &o) noexcept(!IS_DEBUG) :
        D3D12_ROOT_DESCRIPTOR_TABLE1(o)
    {}
    CD3DX12_ROOT_DESCRIPTOR_TABLE1(
        UINT numDescriptorRanges,
        _In_reads_opt_(numDescriptorRanges) const D3D12_DESCRIPTOR_RANGE1* _pDescriptorRanges) noexcept(!IS_DEBUG)
    {
        Init(numDescriptorRanges, _pDescriptorRanges);
    }
...
struct CD3DX12_ROOT_DESCRIPTOR1 : public D3D12_ROOT_DESCRIPTOR1
{
    ...
    explicit CD3DX12_ROOT_DESCRIPTOR1(const D3D12_ROOT_DESCRIPTOR1 &o) noexcept(!IS_DEBUG) :
        D3D12_ROOT_DESCRIPTOR1(o)
    {}
    CD3DX12_ROOT_DESCRIPTOR1(
        UINT shaderRegister,
        UINT registerSpace = 0,
        D3D12_ROOT_DESCRIPTOR_FLAGS flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1
{
    ...
    explicit CD3DX12_ROOT_PARAMETER1(const D3D12_ROOT_PARAMETER1 &o) noexcept(!IS_DEBUG) :
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC : public D3D12_VERSIONED_ROOT_SIGNATURE_DESC
{
    ...
    explicit CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(const D3D12_VERSIONED_ROOT_SIGNATURE_DESC &o) noexcept(!IS_DEBUG) :
        D3D12_VERSIONED_ROOT_SIGNATURE_DESC(o)
    {}
    explicit CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(const D3D12_ROOT_SIGNATURE_DESC &o) noexcept(!IS_DEBUG)
    {
        Version = D3D_ROOT_SIGNATURE_VERSION_1_0;
        Desc_1_0 = o;
    }
    explicit CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(const D3D12_ROOT_SIGNATURE_DESC1 &o) noexcept(!IS_DEBUG)
    {
    ...
    CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(CD3DX12_DEFAULT) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    explicit CD3DX12_CPU_DESCRIPTOR_HANDLE(const D3D12_CPU_DESCRIPTOR_HANDLE &o) noexcept(!IS_DEBUG) :
        D3D12_CPU_DESCRIPTOR_HANDLE(o)
    {}
    CD3DX12_CPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT) noexcept(!IS_DEBUG) { ptr = 0; }
    CD3DX12_CPU_DESCRIPTOR_HANDLE(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &other, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(other, offsetScaledByIncrementSize);
    }
    CD3DX12_CPU_DESCRIPTOR_HANDLE(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &other, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(other, offsetInDescriptors, descriptorIncrementSize);
    }
    CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        ptr = SIZE_T(INT64(ptr) + INT64(offsetInDescriptors) * INT64(descriptorIncrementSize));
        return *this;
    }
    CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        ptr = SIZE_T(INT64(ptr) + INT64(offsetScaledByIncrementSize));
        return *this;
    }
    bool operator==(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE& other) const noexcept(!IS_DEBUG)
    {
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE &operator=(const D3D12_CPU_DESCRIPTOR_HANDLE &other) noexcept(!IS_DEBUG)
    {
        ptr = other.ptr;
        return *this;
    }

    inline void InitOffsetted(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(*this, base, offsetScaledByIncrementSize);
    }

    inline void InitOffsetted(_In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(*this, base, offsetInDescriptors, descriptorIncrementSize);
    }

    static inline void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        handle.ptr = SIZE_T(INT64(base.ptr) + INT64(offsetScaledByIncrementSize));
    }

    static inline void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    explicit CD3DX12_GPU_DESCRIPTOR_HANDLE(const D3D12_GPU_DESCRIPTOR_HANDLE &o) noexcept(!IS_DEBUG) :
        D3D12_GPU_DESCRIPTOR_HANDLE(o)
    {}
    CD3DX12_GPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT) noexcept(!IS_DEBUG) { ptr = 0; }
    CD3DX12_GPU_DESCRIPTOR_HANDLE(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &other, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(other, offsetScaledByIncrementSize);
    }
    CD3DX12_GPU_DESCRIPTOR_HANDLE(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &other, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(other, offsetInDescriptors, descriptorIncrementSize);
    }
    CD3DX12_GPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        ptr = UINT64(INT64(ptr) + INT64(offsetInDescriptors) * INT64(descriptorIncrementSize));
        return *this;
    }
    CD3DX12_GPU_DESCRIPTOR_HANDLE& Offset(INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        ptr = UINT64(INT64(ptr) + INT64(offsetScaledByIncrementSize));
        return *this;
    }
    inline bool operator==(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other) const noexcept(!IS_DEBUG)
    {
        return (ptr == other.ptr);
    }
    inline bool operator!=(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE& other) const noexcept(!IS_DEBUG)
    ...
    CD3DX12_GPU_DESCRIPTOR_HANDLE &operator=(const D3D12_GPU_DESCRIPTOR_HANDLE &other) noexcept(!IS_DEBUG)
    {
        ptr = other.ptr;
        return *this;
    }

    inline void InitOffsetted(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(*this, base, offsetScaledByIncrementSize);
    }

    inline void InitOffsetted(_In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
        InitOffsetted(*this, base, offsetInDescriptors, descriptorIncrementSize);
    }

    static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetScaledByIncrementSize) noexcept(!IS_DEBUG)
    {
        handle.ptr = UINT64(INT64(base.ptr) + INT64(offsetScaledByIncrementSize));
    }

    static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE &handle, _In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base, INT offsetInDescriptors, UINT descriptorIncrementSize) noexcept(!IS_DEBUG)
    {
...
//------------------------------------------------------------------------------------------------
inline constexpr UINT D3D12CalcSubresource( UINT MipSlice, UINT ArraySlice, UINT PlaneSlice, UINT MipLevels, UINT ArraySize ) noexcept(!IS_DEBUG)
{
...
inline void D3D12DecomposeSubresource( UINT Subresource, UINT MipLevels, UINT ArraySize, _Out_ T& MipSlice, _Out_ U& ArraySlice, _Out_ V& PlaneSlice ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
    ...
    explicit CD3DX12_RESOURCE_DESC( const D3D12_RESOURCE_DESC& o ) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_RESOURCE_DESC(
        ...
        D3D12_RESOURCE_FLAGS flags ) noexcept(!IS_DEBUG)
    {
        Dimension = dimension;
        Alignment = alignment;
        Width = width;
    ...
    static inline CD3DX12_RESOURCE_DESC Buffer(
        const D3D12_RESOURCE_ALLOCATION_INFO& resAllocInfo,
        D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE ) noexcept(!IS_DEBUG)
    {
    ...
    static inline CD3DX12_RESOURCE_DESC Buffer(
        ...
        UINT64 alignment = 0 ) noexcept(!IS_DEBUG)
    {
    ...
    inline UINT16 Depth() const noexcept(!IS_DEBUG)
    { return (Dimension == D3D12_RESOURCE_DIMENSION_TEXTURE3D ? DepthOrArraySize : 1); }
    inline UINT16 ArraySize() const noexcept(!IS_DEBUG)
    { return (Dimension != D3D12_RESOURCE_DIMENSION_TEXTURE3D ? DepthOrArraySize : 1); }
    inline UINT8 PlaneCount(_In_ ID3D12Device* pDevice) const noexcept(!IS_DEBUG)
    { return D3D12GetFormatPlaneCount(pDevice, Format); }
    inline UINT Subresources(_In_ ID3D12Device* pDevice) const noexcept(!IS_DEBUG)
    { return MipLevels * ArraySize() * PlaneCount(pDevice); }
    inline UINT CalcSubresource(UINT MipSlice, UINT ArraySlice, UINT PlaneSlice) noexcept(!IS_DEBUG)
    { return D3D12CalcSubresource(MipSlice, ArraySlice, PlaneSlice, MipLevels, ArraySize()); }
};
inline bool operator==( const D3D12_RESOURCE_DESC& l, const D3D12_RESOURCE_DESC& r ) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1
{
    ...
    explicit CD3DX12_RESOURCE_DESC1( const D3D12_RESOURCE_DESC1& o ) noexcept(!IS_DEBUG) :
    ...
    CD3DX12_RESOURCE_DESC1(
        ...
        UINT samplerFeedbackMipRegionDepth = 0) noexcept(!IS_DEBUG)
    {
        Dimension = dimension;
        Alignment = alignment;
        Width = width;
...
inline bool operator==( const D3D12_RESOURCE_DESC1& l, const D3D12_RESOURCE_DESC1& r ) noexcept(!IS_DEBUG)
{
    return l.Dimension == r.Dimension &&
        l.Alignment == r.Alignment &&
        l.Width == r.Width &&
...
struct CD3DX12_VIEW_INSTANCING_DESC : public D3D12_VIEW_INSTANCING_DESC
{
    ...
    explicit CD3DX12_VIEW_INSTANCING_DESC( const D3D12_VIEW_INSTANCING_DESC& o ) noexcept(!IS_DEBUG) :
        D3D12_VIEW_INSTANCING_DESC( o )
    {}
    explicit CD3DX12_VIEW_INSTANCING_DESC( CD3DX12_DEFAULT ) noexcept(!IS_DEBUG)
    {
        ViewInstanceCount = 0;
    ...
    explicit CD3DX12_VIEW_INSTANCING_DESC(
        ...
        D3D12_VIEW_INSTANCING_FLAGS InFlags) noexcept(!IS_DEBUG)
    {
...
inline void MemcpySubresource(
    ...
    UINT NumRows,
    UINT NumSlices) noexcept(!IS_DEBUG)
{
...
inline UINT64 GetRequiredIntermediateSize(
    ...
    _In_range_(0,D3D12_REQ_SUBRESOURCES-FirstSubresource) UINT NumSubresources) noexcept(!IS_DEBUG)
{
...
inline UINT64 UpdateSubresources(
    ...
    _In_reads_(NumSubresources) const D3D12_SUBRESOURCE_DATA* pSrcData) noexcept(!IS_DEBUG)
{
    // Minor validation
...
inline UINT64 UpdateSubresources(
    ...
    _In_reads_(NumSubresources) const UINT64* pRowSizesInBytes,
    _In_ const void* pResourceData,
    _In_reads_(NumSubresources) const D3D12_SUBRESOURCE_INFO* pSrcData) noexcept(!IS_DEBUG)
{
    // Minor validation
    auto IntermediateDesc = pIntermediate->GetDesc();
    auto DestinationDesc = pDestinationResource->GetDesc();
...
inline UINT64 UpdateSubresources(
    ...
    _In_range_(0,D3D12_REQ_SUBRESOURCES-FirstSubresource) UINT NumSubresources,
    _In_ const void* pResourceData,
    _In_reads_(NumSubresources) D3D12_SUBRESOURCE_INFO* pSrcData) noexcept(!IS_DEBUG)
{
    UINT64 RequiredSize = 0;
    auto MemToAlloc = static_cast<UINT64>(sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) + sizeof(UINT) + sizeof(UINT64)) * NumSubresources;
    if (MemToAlloc > SIZE_MAX)
...
//------------------------------------------------------------------------------------------------
inline constexpr bool D3D12IsLayoutOpaque( D3D12_TEXTURE_LAYOUT Layout ) noexcept(!IS_DEBUG)
{ return Layout == D3D12_TEXTURE_LAYOUT_UNKNOWN || Layout == D3D12_TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE; }

//------------------------------------------------------------------------------------------------
template <typename t_CommandListType>
inline ID3D12CommandList * const * CommandListCast(t_CommandListType * const * pp) noexcept(!IS_DEBUG)
{
...
inline HRESULT D3DX12SerializeVersionedRootSignature(
    ...
    _Always_(_Outptr_opt_result_maybenull_) ID3DBlob** ppErrorBlob) noexcept(!IS_DEBUG)
{
...
struct CD3DX12_RT_FORMAT_ARRAY : public D3D12_RT_FORMAT_ARRAY
{
    ...
    explicit CD3DX12_RT_FORMAT_ARRAY(const D3D12_RT_FORMAT_ARRAY& o) noexcept(!IS_DEBUG)
        : D3D12_RT_FORMAT_ARRAY(o)
    {}
    explicit CD3DX12_RT_FORMAT_ARRAY(_In_reads_(NumFormats) const DXGI_FORMAT* pFormats, UINT NumFormats) noexcept(!IS_DEBUG)
    {
...
struct DefaultSampleMask { operator UINT() noexcept(!IS_DEBUG) { return UINT_MAX; } };
struct DefaultSampleDesc { operator DXGI_SAMPLE_DESC() noexcept(!IS_DEBUG) { return DXGI_SAMPLE_DESC{1, 0}; } };
...
public:
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT() noexcept(!IS_DEBUG) : _Type(Type), _Inner(DefaultArg()) {}
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT(InnerStructType const& i) noexcept(!IS_DEBUG) : _Type(Type), _Inner(i) {}
    CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT& operator=(InnerStructType const& i) noexcept(!IS_DEBUG) { _Type = Type; _Inner = i; return *this; }
    operator InnerStructType const&() const noexcept(!IS_DEBUG) { return _Inner; }
    operator InnerStructType&() noexcept(!IS_DEBUG) { return _Inner; }
    InnerStructType* operator&() noexcept(!IS_DEBUG) { return &_Inner; }
    InnerStructType const* operator&() const noexcept(!IS_DEBUG) { return &_Inner; }
};
#pragma warning(pop)
...
struct CD3DX12_PIPELINE_STATE_STREAM2
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM2(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
    ...
    {}
    CD3DX12_PIPELINE_STATE_STREAM2(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , PrimitiveTopologyType(Desc.PrimitiveTopologyType)
        ...
        , ViewInstancingDesc(CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT()))
    {}
    CD3DX12_PIPELINE_STATE_STREAM2(const D3D12_COMPUTE_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
    ...
    D3D12_GRAPHICS_PIPELINE_STATE_DESC GraphicsDescV0() const noexcept(!IS_DEBUG)
    {
    ...
    D3D12_COMPUTE_PIPELINE_STATE_DESC ComputeDescV0() const noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_PIPELINE_STATE_STREAM1
{
    ...
    // Mesh and amplification shaders must be set manually, since they do not have representation in D3D12_GRAPHICS_PIPELINE_STATE_DESC
    CD3DX12_PIPELINE_STATE_STREAM1(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , InputLayout(Desc.InputLayout)
        ...
        , ViewInstancingDesc(CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT()))
    {}
    CD3DX12_PIPELINE_STATE_STREAM1(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , PrimitiveTopologyType(Desc.PrimitiveTopologyType)
        ...
        , ViewInstancingDesc(CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT()))
    {}
    CD3DX12_PIPELINE_STATE_STREAM1(const D3D12_COMPUTE_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , CS(CD3DX12_SHADER_BYTECODE(Desc.CS))
...
struct CD3DX12_PIPELINE_MESH_STATE_STREAM
{
    ...
    CD3DX12_PIPELINE_MESH_STATE_STREAM(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , PS(Desc.PS)
    ...
    CD3DX12_PIPELINE_STATE_STREAM_CACHED_PSO CachedPSO;
    CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING ViewInstancingDesc;
    D3DX12_MESH_SHADER_PIPELINE_STATE_DESC MeshShaderDescV0() const noexcept(!IS_DEBUG)
    {
...
struct CD3DX12_PIPELINE_STATE_STREAM
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , InputLayout(Desc.InputLayout)
        ...
        , CachedPSO(Desc.CachedPSO)
    {}
    CD3DX12_PIPELINE_STATE_STREAM(const D3D12_COMPUTE_PIPELINE_STATE_DESC& Desc) noexcept(!IS_DEBUG)
        : Flags(Desc.Flags)
        , NodeMask(Desc.NodeMask)
        , pRootSignature(Desc.pRootSignature)
        , CS(CD3DX12_SHADER_BYTECODE(Desc.CS))
...
struct CD3DX12_PIPELINE_STATE_STREAM2_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM2_PARSE_HELPER() noexcept(!IS_DEBUG)
        : SeenDSS(false)
    {
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER() noexcept(!IS_DEBUG)
        : SeenDSS(false)
    {
        // Adjust defaults to account for absent members.
        PipelineStream.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
...
inline D3D12_PIPELINE_STATE_SUBOBJECT_TYPE D3DX12GetBaseSubobjectType(D3D12_PIPELINE_STATE_SUBOBJECT_TYPE SubobjectType) noexcept(!IS_DEBUG)
{
...
//------------------------------------------------------------------------------------------------
inline bool operator==( const D3D12_CLEAR_VALUE &a, const D3D12_CLEAR_VALUE &b) noexcept(!IS_DEBUG)
{
...
inline bool operator==( const D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS &a, const D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS &b) noexcept(!IS_DEBUG)
{
    return a.ClearValue == b.ClearValue;
}
inline bool operator==( const D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS &a, const D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS &b) noexcept(!IS_DEBUG)
{
...
inline bool operator==( const D3D12_RENDER_PASS_BEGINNING_ACCESS &a, const D3D12_RENDER_PASS_BEGINNING_ACCESS &b) noexcept(!IS_DEBUG)
{
    if (a.Type != b.Type) return false;
    if (a.Type == D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_CLEAR && !(a.Clear == b.Clear)) return false;
    return true;
}
inline bool operator==( const D3D12_RENDER_PASS_ENDING_ACCESS &a, const D3D12_RENDER_PASS_ENDING_ACCESS &b) noexcept(!IS_DEBUG)
{
    if (a.Type != b.Type) return false;
    if (a.Type == D3D12_RENDER_PASS_ENDING_ACCESS_TYPE_RESOLVE && !(a.Resolve == b.Resolve)) return false;
    return true;
}
inline bool operator==( const D3D12_RENDER_PASS_RENDER_TARGET_DESC &a, const D3D12_RENDER_PASS_RENDER_TARGET_DESC &b) noexcept(!IS_DEBUG)
{
...
inline bool operator==( const D3D12_RENDER_PASS_DEPTH_STENCIL_DESC &a, const D3D12_RENDER_PASS_DEPTH_STENCIL_DESC &b) noexcept(!IS_DEBUG)
{
    if (a.cpuDescriptor.ptr != b.cpuDescriptor.ptr) return false;
...
{
public:
    CD3DX12_STATE_OBJECT_DESC() noexcept(!IS_DEBUG)
    {
        Init(D3D12_STATE_OBJECT_TYPE_COLLECTION);
    }
    CD3DX12_STATE_OBJECT_DESC(D3D12_STATE_OBJECT_TYPE Type) noexcept(!IS_DEBUG)
    {
        Init(Type);
    }
    void SetStateObjectType(D3D12_STATE_OBJECT_TYPE Type) noexcept(!IS_DEBUG) { m_Desc.Type = Type; }
...
private:
    ...
    void Init(D3D12_STATE_OBJECT_TYPE Type) noexcept(!IS_DEBUG)
    {
    ...
    public:
        ...
        void clear() noexcept(!IS_DEBUG) { m_Strings.clear(); }
    private:
    ...
    {
    public:
        SUBOBJECT_HELPER_BASE() noexcept(!IS_DEBUG) { Init(); }
        virtual ~SUBOBJECT_HELPER_BASE() = default;
        virtual D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept(!IS_DEBUG) = 0;
    ...
    protected:
        virtual void* Data() noexcept(!IS_DEBUG) = 0;
        void Init() noexcept(!IS_DEBUG) { m_pSubobject = nullptr; }
    ...
    {
    public:
        OWNED_HELPER(const SUBOBJECT_HELPER_BASE* pHelper) noexcept(!IS_DEBUG) { m_pHelper = pHelper; }
...
{
public:
    CD3DX12_DXIL_LIBRARY_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetDXILLibrary(const D3D12_SHADER_BYTECODE* pCode) noexcept(!IS_DEBUG)
    {
    ...
    D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept(!IS_DEBUG) override
    {
        return D3D12_STATE_SUBOBJECT_TYPE_DXIL_LIBRARY;
    }
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_DXIL_LIBRARY_DESC&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
    ...
    void* Data() noexcept(!IS_DEBUG) override { return &m_Desc; }
...
{
public:
    CD3DX12_EXISTING_COLLECTION_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetExistingCollection(ID3D12StateObject*pExistingCollection) noexcept(!IS_DEBUG)
    {
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_EXISTING_COLLECTION_DESC&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_SUBOBJECT_TO_EXPORTS_ASSOCIATION_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetSubobjectToAssociate(const D3D12_STATE_SUBOBJECT& SubobjectToAssociate) noexcept(!IS_DEBUG)
    {
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_DXIL_SUBOBJECT_TO_EXPORTS_ASSOCIATION&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_HIT_GROUP_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetHitGroupType(D3D12_HIT_GROUP_TYPE Type) noexcept(!IS_DEBUG) { m_Desc.Type = Type; }
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_HIT_GROUP_DESC&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_RAYTRACING_SHADER_CONFIG_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void Config(UINT MaxPayloadSizeInBytes, UINT MaxAttributeSizeInBytes) noexcept(!IS_DEBUG)
    {
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_RAYTRACING_SHADER_CONFIG&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_RAYTRACING_PIPELINE_CONFIG_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void Config(UINT MaxTraceRecursionDepth) noexcept(!IS_DEBUG)
    {
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_RAYTRACING_PIPELINE_CONFIG&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_RAYTRACING_PIPELINE_CONFIG1_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void Config(UINT MaxTraceRecursionDepth, D3D12_RAYTRACING_PIPELINE_FLAGS Flags) noexcept(!IS_DEBUG)
    {
        m_Desc.MaxTraceRecursionDepth = MaxTraceRecursionDepth;
        m_Desc.Flags = Flags;
    }
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_RAYTRACING_PIPELINE_CONFIG1&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetRootSignature(ID3D12RootSignature* pRootSig) noexcept(!IS_DEBUG)
    {
        m_pRootSig = pRootSig;
    }
    D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept(!IS_DEBUG) override
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator ID3D12RootSignature*() const noexcept(!IS_DEBUG) { return D3DX12_COM_PTR_GET(m_pRootSig); }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
    ...
    void* Data() noexcept(!IS_DEBUG) override { return D3DX12_COM_PTR_ADDRESSOF(m_pRootSig); }
...
{
public:
    CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
...
{
public:
    CD3DX12_STATE_OBJECT_CONFIG_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetFlags(D3D12_STATE_OBJECT_FLAGS Flags) noexcept(!IS_DEBUG)
    {
        m_Desc.Flags = Flags;
    }
    D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept(!IS_DEBUG) override
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_STATE_OBJECT_CONFIG&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
...
{
public:
    CD3DX12_NODE_MASK_SUBOBJECT() noexcept(!IS_DEBUG)
    {
        Init();
    }
    ...
    void SetNodeMask(UINT NodeMask) noexcept(!IS_DEBUG)
    {
    ...
    operator const D3D12_STATE_SUBOBJECT&() const noexcept(!IS_DEBUG) { return *m_pSubobject; }
    operator const D3D12_NODE_MASK&() const noexcept(!IS_DEBUG) { return m_Desc; }
private:
    void Init() noexcept(!IS_DEBUG)
    {
        SUBOBJECT_HELPER_BASE::Init();
