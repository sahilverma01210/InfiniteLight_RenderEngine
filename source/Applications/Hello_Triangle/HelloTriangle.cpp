...
void HelloTriangle::createSurface(HINSTANCE hInstance, HWND hWnd) {
...
void HelloTriangle::recordCommandBuffer(VkCommandBuffer commandBuffer, UINT imageIndex) {
...
VKAPI_ATTR VkBool32 VKAPI_CALL HelloTriangle::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
